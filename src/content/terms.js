/**
 * Terms of Service, as supplied by YOUXEL Technology.
 *
 * The text is the client's and is set verbatim. Three things were changed, all
 * of them paste damage rather than drafting, and all three are listed here so
 * the edit is on the record rather than buried:
 *
 *   1. A line reading "You have surpassed your 1 policy limit. Please upgrade
 *      to publish additional policies." sat at the end of section 11. It is an
 *      error message from the tool the document was generated in, not a term,
 *      and it is dropped.
 ...
 *
 * Structure rather than a blob of HTML, so the page can build its own contents
 * list from the same source the body is set from and the two cannot fall out of
 * step. `id` is what a link into a section points at; it is derived from the
 * heading and must not change once the page is public, because a term is a
 * thing people cite by URL.
 */
...
export const termsMeta = {
  ...
  /*
   * The document carries an effective date at its foot and a "Last updated"
   * heading with nothing after it.
   *
   * TODO(legal): supply the last-updated date. Until then this states the
   * effective date only, which is the one fact the document actually gives.
   *
   * The subtitle the document was pasted with, "Your Privacy Matters", is not
   * here: it belongs to the Privacy Policy and is set on that page instead.
   */
  dates: 'Effective 1 September 2023',
}
...
export const terms = [
  {
    ...
    blocks: [
      {
        type: 'p',
        text: 'These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and YOUXEL Technology), concerning your access to and use of the website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Site”). We are registered in Riyadh, Saudi Arabia and have our registered office at Level 7, Building 4.07, King Abdullah Financial District, Riyadh, Saudi Arabia. You agree that by accessing the Site, you have read, understood, and agree to be bound by all of these Terms of Use. If you do not agree with all of these terms of use, then you are expressly prohibited from using the site and you must discontinue use immediately.',
      },
      {
        type: 'p',
  ...
  },
  {
    ...
    blocks: [
      { type: 'p', text: 'We accept the following forms of payment: Visa and Bank Transfer' },
      {
        type: 'p',
  ...
  },
  {
    ...
    blocks: [
      {
        type: 'p',
        text: 'You can cancel your subscription at any time by logging into your account or contacting us using the contact information provided below. Your cancellation will take effect at the end of the current paid term.',
      },
      {
        type: 'p',
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'p', text: 'As a user of the Site, you agree not to:' },
      {
        type: 'ul',
        items: [
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        type: 'p',
        text: 'By submitting suggestions or other feedback regarding the Site, you agree that we can use and share such feedback for any purpose without compensation to you.',
      },
      {
        type: 'p',
  ...
  },
  {
    ...
    blocks: [
      {
        type: 'p',
        text: 'These Terms shall be governed by and defined following the laws of Saudi Arabia. and yourself irrevocably consent that the courts of Saudi Arabia shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these terms.',
      },
    ],
  },
  {
    ...
    blocks: [
      ...
      {
        type: 'p',
        text: 'If the Parties are unable to resolve a Dispute through informal negotiations, the Dispute (except those Disputes expressly excluded below) will be finally and exclusively resolved by binding arbitration. You understand that without this provision, you would have the right to sue in court and have a jury trial. The arbitration shall be commenced and conducted under the Commercial Arbitration Rules of the American Arbitration Association ("AAA") and, where appropriate, the AAA’s Supplementary Procedures for Consumer Related Disputes ("AAA Consumer Rules"), both of which are available at the AAA website www.adr.org. Your arbitration fees and your share of arbitrator compensation shall be governed by the AAA Consumer Rules and, where appropriate, limited by the AAA Consumer Rules. The arbitration may be conducted in person, through the submission of documents, by phone, or online. The arbitrator will make a decision in writing, but need not provide a statement of reasons unless requested by either Party. The arbitrator must follow applicable law, and any award may be challenged if the arbitrator fails to do so. Except where otherwise required by the applicable AAA rules or applicable law, the arbitration will take place in Saudi Arabia. Except as otherwise provided herein, the Parties may litigate in court to compel arbitration, stay proceedings pending arbitration, or to confirm, modify, vacate, or enter judgment on the award entered by the arbitrator.',
      },
      {
        type: 'p',
        text: 'If for any reason, a Dispute proceeds in court rather than arbitration, the Dispute shall be commenced or prosecuted in the state and federal courts located in Saudi Arabia, and the Parties hereby consent to, and waive all defenses of lack of personal jurisdiction, and forum non conveniens with respect to venue and jurisdiction in such state and federal courts. Application of the United Nations Convention on Contracts for the International Sale of Goods and the Uniform Computer Information Transaction Act (UCITA) are excluded from these Terms of Use.',
      },
      {
        type: 'p',
  ...
  },
  {
    ...
    blocks: [
      ...
      /*
       * The document labels this number "United States Phone" and then gives a
       * Saudi one. Set as written, and flagged back for a decision rather than
